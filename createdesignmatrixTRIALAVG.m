...
alleyeavg = (alleyeavgboth - nanmin(alleyeavgboth))/(nanmax(alleyeavgboth)-nanmin(alleyeavgboth));
...
allwhiskingDLCavg = (allwhiskingDLCavgboth - nanmin(allwhiskingDLCavgboth))/(nanmax(allwhiskingDLCavgboth)-nanmin(allwhiskingDLCavgboth));
...
alleyeDLCavg = (alleyeDLCavgboth - nanmin(alleyeDLCavgboth))/(nanmax(alleyeDLCavgboth)-nanmin(alleyeDLCavgboth));
...
allpupilDLCavg = (allpupilDLCavgboth - nanmin(allpupilDLCavgboth))/(nanmax(allpupilDLCavgboth)-nanmin(allpupilDLCavgboth));
...
allmouthDLCavg = (allmouthDLCavgboth - nanmin(allmouthDLCavgboth))/(nanmax(allmouthDLCavgboth)-nanmin(allmouthDLCavgboth));
...
allnoseDLCavg = (allnoseDLCavgboth - nanmin(allnoseDLCavgboth))/(nanmax(allnoseDLCavgboth)-nanmin(allnoseDLCavgboth));
...
allpupilavg = (allpupilavgboth - nanmin(allpupilavgboth))/(nanmax(allpupilavgboth)-nanmin(allpupilavgboth));
...
allrunningavg = (allrunningavgboth - nanmin(allrunningavgboth))/(nanmax(allrunningavgboth)-nanmin(allrunningavgboth));
...
allsaccadesavg = (allsaccadesavgboth - nanmin(allsaccadesavgboth))/(nanmax(allsaccadesavgboth)-nanmin(allsaccadesavgboth));
...
for a = 1:length(S1allcells)
    ...
    S1VOLCatbinned(a,:) = (S1VOLCatbinnedboth(a,:) - nanmin(S1VOLCatbinnedboth(a,:)))/(nanmax(S1VOLCatbinnedboth(a,:))-nanmin(S1VOLCatbinnedboth(a,:)));
...
for a = 1:length(STRallcells)
    ...
    STRVOLCatbinned(a,:) = (STRVOLCatbinnedboth(a,:) - nanmin(STRVOLCatbinnedboth(a,:)))/(nanmax(STRVOLCatbinnedboth(a,:))-nanmin(STRVOLCatbinnedboth(a,:)));
...
for a = 1:length(BLAallcells)
    ...
    BLAVOLCatbinned(a,:) = (BLAVOLCatbinnedboth(a,:) - nanmin(BLAVOLCatbinnedboth(a,:)))/(nanmax(BLAVOLCatbinnedboth(a,:))-nanmin(BLAVOLCatbinnedboth(a,:)));
...
for a = 1:length(S1allcells)
    ...
    S1FORCCatbinned(a,:) = (S1FORCCatbinnedboth(a,:) - nanmin(S1FORCCatbinnedboth(a,:)))/(nanmax(S1FORCCatbinnedboth(a,:))-nanmin(S1FORCCatbinnedboth(a,:)));
...
for a = 1:length(STRallcells)
    ...
    STRFORCCatbinned(a,:) = (STRFORCCatbinnedboth(a,:) - nanmin(STRFORCCatbinnedboth(a,:)))/(nanmax(STRFORCCatbinnedboth(a,:))-nanmin(STRFORCCatbinnedboth(a,:)));
...
for a = 1:length(BLAallcells)
    ...
    BLAFORCCatbinned(a,:) = (BLAFORCCatbinnedboth(a,:) - nanmin(BLAFORCCatbinnedboth(a,:)))/(nanmax(BLAFORCCatbinnedboth(a,:))-nanmin(BLAFORCCatbinnedboth(a,:)));
...
mkdir AllModelDesignMatricesAVG
cd AllModelDesignMatricesAVG
