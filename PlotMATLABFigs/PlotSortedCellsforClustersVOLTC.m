...
%%
S1WT = find(groupS1volALL == "WT");
S1KO = find(groupS1volALL == "KO");
...
STRWT = find(groupSTRvolALL == "WT");
STRKO = find(groupSTRvolALL == "KO");

testSTRWTALL = testSTRALL(STRWT,:);
idxSTRWT = idxSTR(STRWT);
cluorder = [1,2,3,4,5,6];
...
BLAWT = find(groupBLAvolALL == "WT");
BLAKO = find(groupBLAvolALL == "KO");
